  ...
  return (
    <div className="flex gap-10 items-center">
      <BlurFade delay={3.6}>
        <div 
          ref={sourceRef}
          className={`relative bg-sand-50 w-16 h-16 flex rounded-xl shadow-sm items-center justify-center ${isInstalled ? 'opacity-0' : isDragging ? 'cursor-grabbing' : 'cursor-grab'}`}
      ...
      <BlurFade delay={3.7}>
        <img 
          className={`w-10 h-10 transition-opacity duration-300 ${isInstalled ? 'opacity-0' : 'opacity-100'}`} 
          src="/drag-arrow.svg" 
          alt="Drag" 
        />
      </BlurFade>
